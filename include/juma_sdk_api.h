...
void on_connection_state_changed(uint8_t is_connected);
void on_message_from_phone(uint8_t message_type, uint8_t* data, uint32_t size);
void on_message_from_serial(uint8_t message_type, uint8_t* data, uint32_t size);
...
uint8_t is_phone_connected(void);
void disconnect_phone(void);
void send_to_phone(uint8_t message_type, uint8_t* data, uint32_t size);
void setup_serial_port(uint8_t rx_pin, uint8_t tx_pin, uint8_t irq_pin);
void send_to_serial(uint8_t message_type, uint8_t* data, uint32_t size);
